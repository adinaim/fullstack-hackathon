    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tour', models.ManyToManyField(through='booking.TourItems', to='business.guide')),
        ...
        migrations.AddField(
            model_name='touritems',
            name='tour',
            field=models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, related_name='items', to='business.guide'),
        ),
    ]
